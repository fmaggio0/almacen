                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" style="width: 100%" name="name" type="text" value="{{ $role->name or '' }}" required>
                            </div>
                            <label class="control-label col-sm-2">Nombre a mostrar:</label>
                            <div class="col-sm-4">
                                <input class="form-control" style="width: 100%" name="display_name" type="text" value="{{ $role->display_name or '' }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">Descripción:</label>
                            <div class="col-sm-4">
                                <input class="form-control" style="width: 100%" name="description" type="text" value="{{ $role->description or '' }}" required>
                            </div>
                    ...
                    <div class="panel-footer">
                        <input name="usuario" type="hidden" value="{{ $role->id or 'nuevo'}}">
                        <input name="usuario" type="hidden" value="{{Auth::user()->id}}">
                        <input class="btn btn btn-primary" tabindex="1" type="submit" value="Crear rol">
                    </div>
                </div>
            </div>
        </div>
